...
np.save('rms_a2744.npy', np.sqrt(result_dif))
...
plt.savefig('rms_a2744_2d.pdf')

result_dif_x_a2744 = np.array([result_dif_x])
result_dif_y_a2744 = np.array([result_dif_y])
result_dif = np.concatenate([result_dif_x_a2744, result_dif_y_a2744], axis=0)
np.save('rms_a2744_2d.npy', result_dif)
