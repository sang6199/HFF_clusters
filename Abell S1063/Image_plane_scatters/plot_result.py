...
np.save('rms_as1063.npy', np.sqrt(result_dif))
...
plt.savefig('rms_as1063_2d.pdf')

result_dif_x_as1063 = np.array([result_dif_x])
result_dif_y_as1063 = np.array([result_dif_y])
result_dif = np.concatenate([result_dif_x_as1063, result_dif_y_as1063], axis=0)
np.save('rms_as1063_2d.npy', result_dif)
